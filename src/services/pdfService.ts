...
import { ReactPDFService, generateReactPDF } from './reactPdfService';

// Legacy jsPDF service import (keeping for backup)
// import { CallsheetPDFService } from './pdfCustomizationService_jspdf_backup';
